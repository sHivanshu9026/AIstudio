...
const Footer = () => {
  return (
        ...
        <div className ="md:max-w-96">
           <img className="h-9" src={assets.logo} alt="dummyLogoDark" />
            <p className ="mt-6 text-sm">
               Experience the power of AI with AIstudio.<br />Transform your content creation with our suite of premium AI tools.Write articles,generate images,and enhance your workflow.
            </p>
        </div>
    ...
    <p className ="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © ShivanshuAgarwal. All Right Reserved.
    </p>
</footer>
  )
}
